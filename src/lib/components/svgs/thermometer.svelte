...
<svg xmlns="http://www.w3.org/2000/svg" class={className} {width} {height} viewBox="0 0 64 64"
	><defs
		><linearGradient
			...
			><stop offset="0" stop-color="#515a69" stop-opacity=".05" /><stop
				offset=".45"
				stop-color="#6b7280"
				stop-opacity=".05"
			/><stop offset="1" stop-color="#384354" stop-opacity=".1" /></linearGradient
		><linearGradient
			id="thermometer_b"
			x1="23.48"
			x2="39.43"
			...
			/></linearGradient
		></defs
	><circle cx="32" cy="42" r="4.5" fill="#ef4444" /><path
		fill="none"
		stroke="#ef4444"
		...
		/></path
	><path
		fill="url(#thermometer_a)"
		stroke="url(#thermometer_b)"
		stroke-linecap="round"
